...
*   **Kết nối Hooks:** Import và sử dụng các hooks từ `apps/web/src/_lib/hooks/finance.tsx` (ví dụ: `useTransactions`, `useS2SSummary`) vào các Client Component tương ứng.
