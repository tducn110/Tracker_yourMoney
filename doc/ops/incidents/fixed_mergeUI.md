...
Tài liệu này ghi lại toàn bộ các thay đổi cốt lõi nhằm đưa dự án **Finance Tracker** từ trạng thái "Nửa vời" (Vite + Next.js hỗn hợp) về trạng thái **Staff-grade Next.js 15 Pure Architecture**.
