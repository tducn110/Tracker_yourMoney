# UPDATE: FULL TRANSACTIONS CRUD — S2S Finance
...
- **useDeleteTransaction:** Xóa giao dịch và đồng bộ lại các chỉ số S2S ngay lập tức.
...
- [x] **Delete Flow:** `AlertDialog` hiển thị đúng, xóa xong các chỉ số S2S và Balance cập nhật lại chuẩn xác.
