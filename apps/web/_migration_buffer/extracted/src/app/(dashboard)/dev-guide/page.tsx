      ...
      <div className="flex gap-2 bg-gray-100 p-1 rounded-xl overflow-x-auto">
        {tabs.map(({ key, label, icon: Icon }) => (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-[12px] font-black transition-all flex-shrink-0 active:scale-95"
            style={
              activeTab === key
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm divide-y divide-gray-50">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 px-4 py-3">
                  <div className="w-5 h-5 rounded-md bg-blue-50 border-2 border-blue-200 flex items-center justify-center flex-shrink-0">
