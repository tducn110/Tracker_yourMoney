...
function WalletSelector({ selectedId, onChange }: WalletSelectorProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-5 py-3 border-b border-gray-100 bg-gray-50/50">
      <WalletIcon size={13} className="text-gray-400 flex-shrink-0" />
        ...
        {wallets.map((w) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold flex-shrink-0 transition-all active:scale-95"
              style={{
...
function TransactionPreview({ amount, typeConfig, category, walletName, walletIcon }: TransactionPreviewProps) {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
      <div className="flex items-center gap-2">
        <div
