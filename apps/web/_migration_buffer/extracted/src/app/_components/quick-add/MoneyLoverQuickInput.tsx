...
export function MoneyLoverQuickInput() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl shadow-xl overflow-hidden">
      {/* Type Toggle */}
      ...
      {/* Amount Input */}
      <div className="px-6 py-8 bg-gradient-to-b from-transparent to-black/10">
