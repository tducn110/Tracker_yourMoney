...
export function SidebarLogo({ open, onToggle }: SidebarLogoProps) {
  return (
    <div className="flex items-center gap-3 px-4 py-5 h-[72px] relative flex-shrink-0">
      {/* App icon */}
      <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/40 hover:scale-105 transition-transform active:scale-95 cursor-default">
