...
import { formatCurrency, Budget, Category } from '@finance/api-client';
...
export function BudgetFormModal({ isOpen, onClose, onSubmit, initialData }: BudgetFormModalProps) {
  ...
  const EXPENSE_CATEGORIES = categories.filter((c: Category) => c.type !== 'income');
