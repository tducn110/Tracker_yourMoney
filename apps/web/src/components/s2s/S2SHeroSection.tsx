...
export const mockS2SData = {
  ...
  fixedExpenses: { total: 8500000 },
  savingsCommitment: { total: 5000000 },
  emergencyBuffer: 1500000,
  s2sBudget: 10000000,
  s2sSpent: 4200000,
  s2sRemaining: 4800000,
  usagePercent: 42,
  status: "safe" as S2SStatus,
};

export const mockS2SByPeriod: Record<S2SPeriod, { budget: number; spent: number; remaining: number; percent: number; status: S2SStatus }> = {
  today: { budget: 333333, spent: 145000, remaining: 188333, percent: 43, status: "safe" },
  week: { budget: 2333333, spent: 920000, remaining: 1413333, percent: 39, status: "safe" },
  month: { budget: 10000000, spent: 4200000, remaining: 5800000, percent: 42, status: "safe" },
};
