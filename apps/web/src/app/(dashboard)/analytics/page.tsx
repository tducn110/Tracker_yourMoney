...
const mockTransactions = [
  { id: '1', amount: 50000, type: 'expense', category: 'Ăn uống' },
  { id: '2', amount: 1500000, type: 'expense', category: 'Mua sắm' },
  { id: '3', amount: 20000000, type: 'income', category: 'Lương' },
  { id: '4', amount: 300000, type: 'expense', category: 'Di chuyển' },
];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-5">
          ...
          <p className="text-2xl font-bold text-blue-700">{formatCurrency("144000000", "vi-VN")}</p>
        </div>
        <div className="bg-linear-to-br from-red-50 to-orange-50 rounded-xl border border-red-200 p-5">
          ...
          <p className="text-2xl font-bold text-red-700">{formatCurrency("98300000", "vi-VN")}</p>
        </div>
        <div className="bg-linear-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200 p-5">
          ...
          <p className="text-2xl font-bold text-green-700">{formatCurrency("45700000", "vi-VN")}</p>
        </div>
      </div>
