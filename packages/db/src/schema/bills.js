...
import { bigint, int, decimal, varchar, tinyint, timestamp, char, text, mysqlTable, mysqlEnum, index, check, } from "drizzle-orm/mysql-core";
...
export const billPayments = mysqlTable("bill_payments", {
    id: bigint("id", { mode: "bigint", unsigned: true }).autoincrement().primaryKey(),
    billId: bigint("bill_id", { mode: "bigint", unsigned: true }).notNull()
